 ...
 * @author sicp
 */
public class QuickCrabCritterRunner 
{
    public static void main(String[] args) 
    {
        ...
        world.add(new Location(6,6), new CircleBug(3));
        world.add(new Location(4, 4), new QuickCrabCritter());
        world.add(new Location(5, 8), new QuickCrabCritter());
        world.show();
    }
}
